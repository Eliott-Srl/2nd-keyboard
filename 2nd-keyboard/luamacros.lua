...
local keyboardIdentifier = '364F7055'                --364F7055 --in the hub
...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\Users\\panth\\Documents\\2nd-keyboard\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
